...
class ContactModel(models.Model):
    ...
    name = models.CharField(max_length=50, verbose_name="Контакт")
...
class Social(models.Model):
    """ Класс модели социалных сетей страницы о нас """
    icon = models.FileField(upload_to="icons/")
    name = models.CharField(max_length=200)
    link = models.URLField()

    class Meta:
        verbose_name = "Социалная сеть"
        verbose_name_plural = "Социалные сети"
